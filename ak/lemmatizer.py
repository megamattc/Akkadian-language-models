...
class AkkadianLemmatizer(Lemmatizer):
    ...
    def create_lookups(self): 
        lookups = Lookups()
        lookups.add_table("lemma_lookup", self.json_to_dict('lookups/ak_norm_lemma_lookup_1_2_5_8_9_10_13_15_16_17_18_19_21_anzu_barutu_codexham_prologue_nere_riao_rinap4_tcma-assur_general.json')) #Calls up json file associated with lemmas of SAA 1+2+9+5+15_anzu_barutu etc, in /lookups directory
