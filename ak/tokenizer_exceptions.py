...

{
   ...
   "bēl ṭābtēšunu":[{ORTH:    "bēl ṭābtēšunu"}],
   ...
   "erēb šamši":[{ORTH:    "erēb šamši"}],
   "ereb šamši":[{ORTH:    "ereb šamši"}],
   "ṣīt libbīya":[{ORTH:    "ṣīt libbīya"}],
   "ṣīt Šamaš":[{ORTH:    "ṣīt Šamaš"}],
   "ṣīt šamši":[{ORTH:    "ṣīt šamši"}],
   ...
   "rab bārûti": [{ORTH: "rab bārûti"}],
   "rab urdāni": [{ORTH: "rab urdāni"}],
   "rab ṣarrāpi": [{ORTH: "rab ṣarrāpi"}],
   "rab şibti": [{ORTH: "rab şibti"}],
   "rab maddaʾti": [{ORTH: "rab maddaʾti"}],
   "rab daria": [{ORTH: "rab daria"}],
   "rab širakū": [{ORTH: "rab širakū"}],
   ...
   "pūt upni":[{ORTH:    "pūt upni"}],
   "rādi kibsi":[{ORTH:    "rādi kibsi"}],
   ...
   "issi ēkallīšu":[{ORTH:    "issi ēkallīšu"}],
   ...
   "rab ešrāti":[{ORTH:    "rab ešrāti"}],
   "mazzassi pāni":[{ORTH:    "mazzassi pāni"}],
   "sekret ēkallātīšu":[{ORTH:    "sekret ēkallātīšu"}],
   ...
   "bēt Mummu": [{ORTH: "bēt Mummu"}],
   "bēt rēšāni": [{ORTH: "bēt rēšāni"}],
   "bēt nakkanti": [{ORTH: "bēt nakkanti"}],
   "bēt nakkamāte": [{ORTH: "bēt nakkamāte"}],
   "bēt unqi": [{ORTH: "bēt unqi"}],
   "bēt erši": [{ORTH: "bēt erši"}],
   "bēt karrāni": [{ORTH: "bēt karrāni"}],
   "bēt kimahhi": [{ORTH: "bēt kimahhi"}],
   ...
   "bēt ša-rēšāni":[{ORTH:    "bēt ša-rēšāni"}],
   ...
   "bēt giṣṣite":[{ORTH:    "bēt giṣṣite"}],
   "bēt papāhi":[{ORTH:    "bēt papāhi"}],
   ...
   "bēt ilānīka":[{ORTH:    "bēt ilānīka"}],
   "bēt ili":[{ORTH:    "bēt ili"}],
   "bēt isitēya":[{ORTH:    "bēt isitēya"}],
   "bēt abīka":[{ORTH:    "bēt abīka"}],
   ...
   "mār ahhēka":[{ORTH:    "mār ahhēka"}],
   "mār ah abbēka":[{ORTH:    "mār ah abbēka"}],
   "mār marʾēšunu":[{ORTH:    "mār marʾēšunu"}],
   "mār marʾēni":[{ORTH:    "mār marʾēni"}],
   "mār marʾi":[{ORTH:    "mār marʾi"}],
   "mār banî":[{ORTH:    "mār banî"}],
   "mār mārīka":[{ORTH:    "mār mārīka"}],
   "mār marʾīšu":[{ORTH:    "mār marʾīšu"}],
   ...
   "mār šiprānēya":[{ORTH:    "mār šiprānēya"}],
   ...
   "Māt-Aššur":[{ORTH:    "Māt-Aššur"}],
   "Māt Aššur":[{ORTH:    "Māt Aššur"}],
   "šikin ṭēmāni":[{ORTH:    "šikin ṭēmāni"}],
