...
class AkkadianLemmatizer(Lemmatizer):
    ...
    def create_lookups(self): #Got the next two functions from stackoverflow. Feels like a hack. 
        lookups = Lookups()
        lookups.add_table("lemma_lookup", self.json_to_dict('lookups/ak_transliteration_lookup_1_5.json')) #Calls up json file associated with lemmas, in /lookups directory
